...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        //     httpOnly: true,
        //     secure: false,  // Disable secure flag for local dev
        //     sameSite: "lax",
        // });
...
app.post("/send-otp", async (req, res) => {
    ...
    if (order != null)
        ...
        otpStore[String(orderId)] = otp;
        // saveOtpToFile(otpStore); // Save OTPs to file
        ...
        try {
            await transporter.sendMail({
                ...
                text: `Your OTP for order ${orderId} is: ${otp}. Please enter this to confirm delivery.`,
            });
...
app.post("/verify-otp", (req, res) => {
    ...
    if (String(otpStore[String(orderId)]) == String(otp)) {
        delete otpStore[String(orderId)];
        // saveOtpToFile(otpStore); // Update file
